package com.google.auroracoin.tools;
...
public class BuildCheckpoints {
    public static void main(String[] args) throws Exception {
        ...
        final NetworkParameters params = AuroraCoinParams.get();
        ...
        final BlockChain chain = new AuroraBlockChain(params, store);
        ...
        final FileOutputStream fileOutputStream = new FileOutputStream("checkpointsauroracoin", false);
        ...
        CheckpointManager manager = new CheckpointManager(params, new FileInputStream("checkpointsauroracoin"));
