...
// TODO Still need to adjust for Sexcoin

public class SexcoinAddressTest {
    static final NetworkParameters mainParams = SexcoinParams.get();
    ...
    public void errorPaths() {
        ...
        try {
            ...
            // Success.
            assertEquals(e.verCode, SexcoinParams.get().getAddressHeader());
    ...
    public void getNetwork() throws Exception {
        ...
        assertEquals(SexcoinParams.get().getId(), params.getId());
    }
}
